    ...
    array_of_prices.each_index do |day|
        ...
        if current_sell_price != array_of_prices.first
            ...
            if current_profit > highest_profit
                ...
                buy_day = array_of_prices.rindex(buy_price)
                sell_day = array_of_prices.rindex(sell_price)
                highest_profit = sell_price - buy_price
            end
        end
    end
    puts "buy on day #{buy_day} for $#{buy_price} | sell day #{sell_day} for $#{sell_price}"
end
